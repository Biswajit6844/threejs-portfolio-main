...
export const workExperiences = [
  {
    ...
    title: "Managed the development of Halyon, an educational card game for schools in collaboration with Rotork and led presentation, marketing strategy, game design, and cost planning efforts.",
    icon: '/assets/rotork.png',
    animation: 'victory',
  },
  {
    id: 2,
    ...
    title: " I ran digital marketing campaigns, increasing donations by 25% and  worked  in boostinmg the SEO traffic by 30% through content optimization..I also led social media lead generation efforts, growing volunteers by 20%",
    icon: '/assets/mus.jpg',
    animation: 'clapping',
  },
  {
    ...
    pos: 'Artificial Intelligence Architect',
    duration: 'Aug 2023 – May 2024',
    title: "Researched UAV-assisted Reconfigurable Intelligent Surfaces (RIS) using Deep Reinforcement Learning.I worked  on improving wireless signal coverage by 35% using optimized UAV and RIS control.",
    icon: '/assets/iiit.jpg',
    animation: 'salute',
  },
  {
  id: 4,
    name: 'ATG-Across The Globe',
  ...
  {
    id: 5,
      name: 'Formosa Synthetics Pvt. Ltd',
